...
"""
errorCompare.py: Perform F- and t-test on two data sets; plot comparative histogram of data.
"""
...
plt.xlabel('Error')
plt.ylabel('Number of final running average errors')
plt.legend(loc='upper left')
plt.grid(True)

plt.savefig('plots/' + combo_fileroot + '-Error.png', dpi = 600)
