...
plt.title('Reward over 30 Random Runs')
plt.xlabel('Episodes')
...
# plt.savefig('plots/Reward over 30 DDQN Runs.png', dpi = 600)
# plt.savefig('plots/Reward over 30 PPO Runs.png', dpi = 600)
# plt.savefig('plots/Reward over 30 PG Runs.png', dpi = 600)
plt.savefig('plots/Reward over 30 Random Runs.png', dpi = 600)
